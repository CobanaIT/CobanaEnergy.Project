...
namespace CobanaEnergy.BackgroundServices.CQRS.Handlers.Commands
{
    ...
    /// Handler for processing contract ended Renewed date contracts
    ...
    /// </summary>
    public class ProcessContractEndedRenewedDateCommandHandler 
        : ICommandHandler<ProcessContractEndedRenewedDateCommand, ProcessContractEndedDateResult>
    {
        ...
        public ProcessContractEndedRenewedDateCommandHandler(
        ...
        public async Task<ProcessContractEndedDateResult> HandleAsync(ProcessContractEndedRenewedDateCommand command)
        {
            var startTime = DateTime.Now;
            
            try
            {
                _logger.LogToFile("=== Handler: ProcessContractEndedRenewedDateCommandHandler Started ===");
                ...
                _logger.LogToFile($"📋 Processing contract ended Renewed date contracts for date: {command.CurrentDate:yyyy-MM-dd}");
        ...
        private void ValidateCommand(ProcessContractEndedRenewedDateCommand command)
        {
            if (command == null)
