...
namespace CobanaEnergy.BackgroundServices.CQRS.Handlers.Commands
{
    ...
    /// Handler for processing contract ended Not Renewed date contracts
    ...
    /// </summary>
    public class ProcessContractEndedNotRenewedDateCommandHandler 
        : ICommandHandler<ProcessContractEndedNotRenewedDateCommand, ProcessContractEndedDateResult>
    {
        ...
        public ProcessContractEndedNotRenewedDateCommandHandler(
        ...
        public async Task<ProcessContractEndedDateResult> HandleAsync(ProcessContractEndedNotRenewedDateCommand command)
        {
            var startTime = DateTime.Now;
            
            try
            {
                _logger.LogToFile("=== Handler: ProcessContractEndedNotRenewedDateCommandHandler Started ===");
                ...
                _logger.LogToFile($"📋 Processing contract ended Not Renewed date contracts for date: {command.CurrentDate:yyyy-MM-dd}");
        ...
        private void ValidateCommand(ProcessContractEndedNotRenewedDateCommand command)
        {
            if (command == null)
